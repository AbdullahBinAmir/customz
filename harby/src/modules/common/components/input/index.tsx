      ...
      <div>
        <div className="relative z-0 w-full text-base-regular">
          <input
            ...
            placeholder=" "
            className={clsx(
              "rounded-full pl-6 pt-4 pb-1 block w-full px-4 mt-0 bg-transparent border appearance-none focus:outline-none focus:ring-0 focus:border-gray-400 border-gray-200",
              {
          ...
          <label
            ...
            className={clsx(
              "pl-3 mx-3 px-1 transition-all absolute duration-300 top-3 -z-1 origin-0 text-gray-500",
              {
