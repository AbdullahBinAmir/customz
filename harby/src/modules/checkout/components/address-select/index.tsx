...
const AddressSelect = ({ addresses }: AddressSelectProps) => {
  ...
  const handleSelect = (id: string) => {
    const savedAddress:any = addresses.find((a) => a.id === id)
    ...
    <Listbox onChange={handleSelect} value={selected}>
      <div className="relative">
        ...
        <Transition
          ...
          leaveTo="opacity-0"
        >
          <Listbox.Options className="absolute z-20 w-full overflow-auto text-small-regular bg-white border border-gray-200 border-top-0 max-h-60 focus:outline-none sm:text-[25px]">
