...
const DesktopSearchModal = () => {
  ...
  return (
    <>
      ...
      {/* <button onClick={open} className="flex items-center gap-x-2 bg-white rounded-full h-12 pl-6 pr-16">
        <Search />
        <span className="text-[#6F6F6F] text-[16px] font-light">Search what are you looking for</span>
      </button> */}
