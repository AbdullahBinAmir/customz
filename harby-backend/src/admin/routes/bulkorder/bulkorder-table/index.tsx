...
import { useBulkOrderColumns } from "./use-bulkorder-columns";
import useAdminBulkOrders from "./use-admin-bulk-order";
...
const BulkOrderTable = () => {
  ...
  const { bulkOrders, isLoading, count } = useAdminBulkOrders(qs.stringify(queryObject));

  const [columns] = useBulkOrderColumns();
