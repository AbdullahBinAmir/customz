...
import CustomizerSection from "../../../edit/sections/customizer"
import SizeGuide from "../../products/edit/sections/sizeguide"
    ...
    <div className="pb-5xlarge">
      ...
      <div className="grid grid-cols-12 gap-x-base">
        <div className="col-span-8 flex flex-col gap-y-xsmall">
          ...
          <CustomizerSection images={product.images} />
        </div>
