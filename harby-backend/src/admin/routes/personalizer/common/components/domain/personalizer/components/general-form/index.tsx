    ...
    <div>
      <div className="mb-large">
        <div className="mb-2xsmall flex items-center justify-between">
          <h2 className="inter-base-semibold">Is Printing</h2>
          <Controller
            control={control}
            name={path("isPrinting")}
        ...
        <p className="inter-base-regular text-grey-50">
          When unchecked printing will not be applied to this product.
        </p>
      </div>
      ...
      <div className="mt-large mb-large">
        <div className="mb-2xsmall flex items-center justify-between">
          <h2 className="inter-base-semibold">Is Embroidery</h2>
          <Controller
            control={control}
            name={path("isEmbroidery")}
            render={({ field: { value, onChange } }) => {
              return <Switch checked={value} onCheckedChange={onChange} />
            }}
          />
        ...
        <p className="inter-base-regular text-grey-50">
          When unchecked embroidery will not be applied to this product.
        </p>
      </div>
      <div className="mb-small grid grid-cols-1 gap-x-large">
        <InputField
          label="Embroidery Text Length"
          type="number"
          placeholder="Embroidery"
          {...register(path("embroideryText"))}
          errors={errors}
        />
      </div>
