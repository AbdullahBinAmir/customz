...
const GeneralModal = ({ product, open, onClose }: Props) => {
  ...
  const onSubmit = handleSubmit((data) => {
    onUpdate(
      {
        // @ts-ignore
        metadata: { isPersonalizer: data.general.isPersonalizer,isEmroidery:data.general.isEmbroidery, embroideryText:data.general.embroideryText, isPrinting: data.general.isPrinting },
...
const getDefaultValues = (product: Product): GeneralFormWrapper => {
  return {
    general: {
      ...
      isEmbroidery:product.metadata.isEmroidery ? true :false, 
      embroideryText:product.metadata.embroideryText as string || "",
      isPrinting: product.metadata.isPrinting ? true : false
    },
    organize: {
