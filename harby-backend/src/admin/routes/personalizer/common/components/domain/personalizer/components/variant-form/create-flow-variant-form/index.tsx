...
const CreateFlowVariantForm = ({ form, options, onCreateOption }: Props) => {
  ...
  // useEffect(() => {
  //   console.log("Watched options changed:", watchedOptions);
  //   if (watchedOptions[0]?.option?.value) {
  ...
  return (
    <Accordion type="multiple" defaultValue={["general"]}>
      <Accordion.Item title="General" value="general" required>
        <div>
          <VariantGeneralForm form={nestedForm(form, "general")} options={options} stock={nestedForm(form, "stock")} />
